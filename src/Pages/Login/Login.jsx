...
function Login() {
  ...
  const [loginLoader, setLoginLoader] = useState(false); // State to handle loader visibility
            ...
            <div className="login-container">
              ...
              <div className="login-form">
                <div className="box">
                  ...
                  <div className="form" onSubmit={handleSubmit}>
                    <form action="">
                      <div className="inputs" ref={usernameRef}>
                        ...
                        <input
                          type="text"
                          onChange={(e) =>
                            userName(e) || setEmail(e.target.value) || setMobileNumber(e.target.value) || setUsername(e.target.value)
                          }
                      ...
                      <div className="login-btn">
                        <button disabled={loginLoader}>{loginLoader ? <LoginLoader/> : "Login" }</button>
                      </div>
                    </form>
                    <div className="lines">
                    ...
                    <div className="other-login">
                      <i className="fa-brands fa-google"></i> <span>Log in with Google</span>
                    </div>
                ...
                <div className="box-second">
                  <p>
                    Don't have an account? <span onClick={signupPageActive}>Sign up</span>
                  </p>
                </div>
